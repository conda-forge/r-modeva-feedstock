...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-modeva-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-modeva-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `r-modeva` available on your platform:
...
```
pixi search r-modeva --channel conda-forge
```
